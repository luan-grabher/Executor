...
public class Carregamento extends javax.swing.JFrame {
    ...
    public Carregamento(String nome, int minValue, int maxValue) {
        initComponents();
        iniciar(nome, minValue, maxValue);
    }

    public void iniciar(String nome, int minValue, int maxValue) {
    ...
    public void atualizar(int valor) {
        atualizar(valor + " de " + maxValue, valor);
    }
    
    public void atualizar(String descricao, int valor) {
